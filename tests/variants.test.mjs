...
test('bordures colorées : chaque côté touché par la couleur du joueur compte', () => {
  // une colonne orange qui touche le bord haut et le bord gauche
  const rows = [
    'OO......',
    'OO......',
    'OO......',
  ...
  // 2 tuiles + bord haut + bord gauche = 4 -> 5 pts
